        ...
        <ul class="metismenu" id="menu">
            ...
            <li class="{{ Route::is('project-management') ? 'mm-active' : '' }}">
                <a href="{{ route('project-management') }}">
                    <i class="fa-solid fa-bars"></i>&nbsp;<span class="nav-text">{{ __('Project Main Data') }}</span></a>
            </li>
            ...
            <li class="{{ Route::is('allocation-of-units') ? 'mm-active' : '' }}"><a href="{{ route('allocation-of-units') }}">
            ...
            <li class="{{ Route::is('withdrawal') ? 'mm-active' : '' }}"><a href="{{ route('withdrawal') }}">
                    <i class="fa-solid fa-bars"></i>&nbsp;<span class="nav-text">{{ __('Withdraw savings') }}</span></a>
            </li>

            <li class="nav-label">{{ __('Operations') }}</li>
            <li class="{{ Route::is('reservations') ? 'mm-active' : '' }}"><a href="{{ route('reservations') }}">
                    <i class="fa-solid fa-bars"></i>&nbsp;<span class="nav-text">{{ __('Reservations') }}</span></a>
            </li>
            ...
            <li class="{{ Route::is('reports.payment-movements') ? 'mm-active' : '' }}">
                <a href="{{ route('reports.payment-movements') }}">
                    <i class="fa-solid fa-bars"></i>&nbsp;<span class="nav-text">{{ __('Movement of payment receipts') }}</span></a>
            </li>

            <li class="{{ Route::is('reports.totel-projects') ? 'mm-active' : '' }}">
                <a href="{{ route('reports.totel-projects') }}">
                    <i class="fa-solid fa-bars"></i>&nbsp;<span class="nav-text">{{ __('Total of each project') }}</span></a>
            </li>

            <li class="{{ Route::is('reports.customer-data') ? 'mm-active' : '' }}">
                <a href="{{ route('reports.customer-data') }}">
                    <i class="fa-solid fa-bars"></i>&nbsp;<span class="nav-text">{{ __('Customer data') }}</span></a>
            </li>
            <li class="{{ Route::is('reports.collection-summary') ? 'mm-active' : '' }}">
                <a href="{{ route('reports.collection-summary') }}">
                    <i class="fa-solid fa-bars"></i>&nbsp;<span class="nav-text">{{ __('Collection Summary') }}</span></a>
            </li>
        </ul>
    </div>
</div>
