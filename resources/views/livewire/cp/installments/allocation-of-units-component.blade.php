            ...
            <div class="container-fluid">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-lg-2 col-md-4">
                        ...
                        <input type="date" wire:model="costs.{{ $index }}.date" class="form-control" placeholder="{{ __('t.date') }}">

                        <input type="number" wire:model="costs.{{ $index }}.value" class="form-control" placeholder="{{ __('Value') }}">
                        ...
                        <br>
                        <button type="button" wire:click="generateCostPayments({{ $index }})" class="btn btn-sm btn-primary btn-rounded">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <label class="btn btn-warning btn-rounded my-4" for="generate">{{ __('Sume The Installments') }}</label>
