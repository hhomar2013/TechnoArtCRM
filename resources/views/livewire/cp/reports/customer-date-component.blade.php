    ...
    @else
        ...
        <div class="card">
            <div class="card-header">
                ...
                <button class="btn btn-danger btn-sm btn-rounded" wire:click.prevent="$set('isShowNotes',false)"><i
            ...
            @empty
                <div class="card-body bg-danger ">
                    <h3 class="text-center text-white"> {{ __('No Data') }} </h3>
                </div>
            @endforelse
        </div>
    @endif
